...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 18. Nov 2019 um 11:05
...
CREATE TABLE `note` (
  ...
  `lehrer` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `note` (`id_Note`, `Kommentar`, `Note`, `Prozent`, `Datum`, `Schueler_id_Schueler`, `Fach_id_Fach`, `NotenTyp_idNotenTyp`, `notenschluesselTyp_Id`, `scoredPoints`, `maxPoints`, `lehrer`) VALUES
(1, '', 2, 81, '2018-05-12', 1, 1, 1, 1, 85, 105, 'TEST'),
(2, '', 1, 100, '2019-09-19', 7, 2, 1, 1, 90, 90, 'PAM'),
(4, '', 3, 74, '2019-09-25', 13, 4, 1, 1, 59, 80, 'TEST'),
(5, '', 5, 44, '2019-07-19', 13, 4, 1, 1, 36, 82, 'PAM'),
(6, '', 3, 75, '2019-02-22', 13, 4, 1, 1, 45, 60, 'PAM'),
(7, '', 2, 83, '2019-08-14', 13, 4, 1, 1, 91, 110, 'PAM'),
(8, '', 2, 82, '2019-09-12', 1, 2, 1, 1, 23, 28, 'PAM');
...
INSERT INTO `notenschluesseltyp` (`idNotenschluesselTyp`, `SchlusselName`, `is15`) VALUES
(1, 'IHK', 0),
(2, 'Abitur', 0),
(4, 'POOP', 0),
(6, 'Test', 0),
...
(4, 'Test', 'Lehrer', '1971-06-12', 3, 'TEST', 'test', '$2y$10$hYfTjgljQ9pMzHoLaBuQOexMR4HSPoKdL68X8K6aQRwJKzoXigSzW', 'test@test.de');
...
ALTER TABLE `note`
  ...
  ADD KEY `lehrer_fk_login` (`lehrer`);
...
--
ALTER TABLE `fach`
  MODIFY `id_Fach` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT für Tabelle `kurs`
--
ALTER TABLE `kurs`
  MODIFY `id_Kurs` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
--
...
--
ALTER TABLE `notenschluesseltyp`
  MODIFY `idNotenschluesselTyp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
...
ALTER TABLE `note`
  ...
  ADD CONSTRAINT `lehrer_fk_login` FOREIGN KEY (`lehrer`) REFERENCES `teacher` (`short`);
